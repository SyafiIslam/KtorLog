package com.example.ktorlog.feature.search

import androidx.compose.runtime.State
import androidx.compose.runtime.mutableStateOf
import androidx.lifecycle.ViewModel
import com.example.ktorlog.data.remote.response.list.FilmData
import com.example.ktorlog.domain.usecase.search.BrowseFilmUseCase
...
class SearchViewModel @Inject constructor(
    ...
    suspend fun browseFilm(type: String, query: String) = browseFilmUseCase(type = type, query = query)
}